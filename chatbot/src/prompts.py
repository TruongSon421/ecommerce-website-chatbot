...
OUTPUT GUIDELINES:
- NEVER include product IDs, productID, or any internal database identifiers in responses to users.
- Only provide user-friendly information such as product names, specifications, prices, and descriptions.
- Keep responses clean and professional without exposing backend data structures.
"""
