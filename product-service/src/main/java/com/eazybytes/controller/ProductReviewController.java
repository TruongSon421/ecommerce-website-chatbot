...
public class ProductReviewController {
    ...
    /**
     * Lấy đánh giá của user hiện tại cho sản phẩm cụ thể
     */
    @GetMapping("/my-reviews/product/{productId}")
    public List<ReviewResponse> getUserReviewsForProduct(@PathVariable String productId) {
        String userId = roleChecker.getCurrentUserId();
        return reviewService.getUserReviewsForProduct(userId, productId);
    }
