    ...
    <div className="mt-10">
      ...
      <div className="mt-6 text-center">
        <div className="group inline-flex text-sm">
          <svg className="flex-shrink-0 mr-2 h-5 w-5 text-gray-400 group-hover:text-gray-500" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd" />
          </svg>
          <span className="text-gray-500 group-hover:text-gray-700">Thanh toán an toàn và bảo mật</span>
        </div>
      </div>
    </div>
  );
